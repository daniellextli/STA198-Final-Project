...
To illustrate the distribution of participants across demographic characteristics and caffeine consumption habits, we examined country, gender, and age. For the categorical variables—country and gender—bar charts were used to display the counts of participants in each group, allowing us to verify that each subgroup was adequately represented. For the continuous variable age, a histogram was used to show the frequency distribution across age intervals, showing how participants were spread across the age range. Overall, these visualizations highlight the distribution of demographic variables in the dataset, ensuring that the sample appropriately represents each subgroup.

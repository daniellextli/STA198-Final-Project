...
--> Insert Logsitic Models (logit stuff)
...
--> Add the Odds ratio and CL stuff (fix the odds ratio)
...
<---In Discussion you say you were unable to do this, but do not fully explain why or tie it to the original goal.
## Discussion 
